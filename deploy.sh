...
scp -i $SSH_KEY pages/admin.html pages/index.html pages/login.html pages/signup.html pages/landing.html pages/pricing.html pages/reset-password.html sw.js manifest.json $VPS:$REMOTE_DIR/public/
# Legal pages
